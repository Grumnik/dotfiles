#! /usr/bin/python3
# opens a sublime project and sets the correct python interpreter
...
DEFAULT_PROJECT_DIR = f"{HOME}/projects/"
...
def create_project_file():
    project = {
        "folders": [
            ...
            {   
                "name": "env",
                "path": f"{space.args.virtual_env}/lib/python3.9/site-packages/",
            }
        ],
        "settings":
        {
